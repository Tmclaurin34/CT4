...
// v6: no-size gifts only (no apparel, on purpose); unified sample-brand gallery. v5: brand samples are fictional. v4: B2B/staffing fit. v3: campaign library, backfill safety.
