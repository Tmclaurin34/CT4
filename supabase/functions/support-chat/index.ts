...
// v10: one-off gifts and print-ready logo cleanup. v9: Growth/Scale pricing updated. v8: Local plan is $49/mo. v7: no-size gifts only (no apparel, on purpose); unified sample-brand gallery. v6: brand samples are fictional. v5: B2B/staffing fit.
...
OTHER FEATURES: Email Studio (design branded emails), Brand Studio (design gift artwork and improve soft logo uploads for print), one-off gift sending from the customer list, open/click tracking on campaigns, satisfaction surveys by text (reply 1-5), AI-written campaign messages, Google review invitations for happy customers.
