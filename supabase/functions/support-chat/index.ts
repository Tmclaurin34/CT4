...
// v11: gift cart for multiple manual recipients. v10: one-off gifts and print-ready logo cleanup. v9: Growth/Scale pricing updated. v8: Local plan is $49/mo. v7: no-size gifts only (no apparel, on purpose); unified sample-brand gallery. v6: brand samples are fictional. v5: B2B/staffing fit.
