...
function welcomeHtml(contactName: string, businessName: string) {
  ...
  const steps = [
    ["1", "Connect your platform", "Square, Shopify, Clover, or Stripe — or skip the POS entirely and grab your QR check-in code."],
    ["2", "Add your customers", "Import a CSV, add them one by one, or let the QR code build your list automatically."],
